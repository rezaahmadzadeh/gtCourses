...
///
/// ikfast version 0x10000049 generated on 2016-11-22 12:04:10.557353
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((((0.081239279693823)*x38))+(((0.081239279693823)*x37))+(((-1.0)*(0.31621584)*x35))+(((-1.0)*(0.114677005508166)*x33))+(((-1.0)*(0.00975)*x2))+((x39*x8))+(((0.31621584)*x36))+(((0.114677005508166)*x19)));
...
eetrans[1]=((((0.114677005508166)*x55))+(((0.114677005508166)*x47))+(((-1.0)*(0.081239279693823)*x60))+(((-1.0)*(1.0)*x2*x39))+(((-1.0)*(0.31621584)*x58))+(((-1.0)*(0.081239279693823)*x59))+(((0.31621584)*x57))+(((-1.0)*(0.00975)*x8)));
...
eetrans[2]=((0.2755)+(((0.31621584)*x63))+(((0.31621584)*x65))+(((-1.0)*(0.41)*x10))+((x3*(((((-1.0)*(0.114677005508166)*x24))+(((0.114677005508166)*x21))))))+(((-1.0)*(0.081239279693823)*x74))+(((-1.0)*(0.081239279693823)*x73)));
}
...
new_r01=r01;
new_r02=((-1.0)*(((1.0)*r02)));
new_px=((((-1.0)*(0.13656408)*r02))+px);
new_r10=r10;
new_r11=((-1.0)*(((1.0)*r11)));
new_r12=r12;
new_py=((((-1.0)*(1.0)*py))+(((0.13656408)*r12)));
new_r20=r20;
new_r21=((-1.0)*(((1.0)*r21)));
new_r22=r22;
new_pz=((0.2755)+(((-1.0)*(1.0)*pz))+(((0.13656408)*r22)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - jaco (57448a67196b4fa1f4931114f5a84b92)>"; }
