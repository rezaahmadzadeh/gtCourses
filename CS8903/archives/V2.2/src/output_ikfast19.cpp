...
///
/// ikfast version 0x10000049 generated on 2016-11-02 12:28:20.394651
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x21=((0.5)*x2);
x22=(x3*x5);
x23=((0.866025403784439)*x22);
x24=(x23*x4);
x25=(x7*x8);
x26=((0.866025403784439)*x25);
x27=(x26*x4);
x28=(x10*(((((-1.0)*(0.5)*x12))+(((-1.0)*(0.5)*x11)))));
x29=(x20*((x28+x27+(((-1.0)*(1.0)*x24))+(((-1.0)*(1.0)*x21)))));
x30=IKsin(j[5]);
x31=(x18*x20);
x32=((1.0)*x15);
x33=(x21+x24+(((-1.0)*(1.0)*x27))+(((-1.0)*(1.0)*x28)));
x34=IKcos(j[5]);
x35=((0.433012701892219)*x22);
x36=((0.433012701892219)*x25);
x37=(x4*((x36+(((-1.0)*(1.0)*x35)))));
x38=(x37+((x20*(((((-1.0)*(0.5)*x28))+(((0.25)*x2))+(((-1.0)*(1.0)*x37))))))+(((0.75)*x2))+(((-1.0)*(0.75)*x14))+((x32*(((((-1.0)*(0.5)*x16))+(((-1.0)*(0.5)*x17)))))));
x39=((0.41)*x3);
x40=(x1*x4);
x41=(x0*x3*x5);
x42=(x0*x7*x8);
...
x52=(x0*x23);
x53=(x0*x26);
x54=(x10*(((((-1.0)*(0.5)*x43))+(((-1.0)*(0.5)*x44)))));
x55=(x20*(((((-1.0)*(1.0)*x52))+x54+x51+x53)));
x56=(x20*x49);
x57=((((-1.0)*(1.0)*x53))+(((-1.0)*(1.0)*x54))+(((-1.0)*(1.0)*x51))+x52);
x58=(x0*x35);
x59=(x0*x36);
x60=((((0.75)*x46))+((x20*(((((-1.0)*(1.0)*x58))+(((0.5)*x54))+(((0.25)*x40))+x59))))+((x15*(((((0.5)*x48))+(((-1.0)*(0.5)*x47))))))+(((-1.0)*(1.0)*x59))+(((0.75)*x40))+x58);
x61=(x3*x7);
x62=(x5*x8);
x63=(x22+(((-1.0)*(1.0)*x25)));
x64=(x1*x15*x63);
x65=((0.866025403784439)*x61);
x66=((0.866025403784439)*x62);
x67=((((-1.0)*(0.5)*x25))+(((0.5)*x22)));
x68=(x10*x67);
x69=(x20*((x68+(((-1.0)*(1.0)*x65))+(((-1.0)*(1.0)*x66)))));
x70=(x1*x20*x63);
x71=(x66+x65+(((-1.0)*(1.0)*x68)));
x72=((0.433012701892219)*x61);
x73=((0.433012701892219)*x62);
x74=(((x20*(((((0.5)*x68))+(((-1.0)*(1.0)*x73))+(((-1.0)*(1.0)*x72))))))+((x1*x15*x67))+x73+x72+((x10*(((((0.866025403784439)*x23))+(((-1.0)*(0.866025403784439)*x26)))))));
eerot[0]=((((-1.0)*(0.433012701892219)*x14))+(((0.866025403784439)*x29))+(((-1.0)*(0.25)*x6))+(((0.25)*x9))+(((0.433012701892219)*x2))+(((0.866025403784439)*x19)));
eerot[1]=(((x30*(((((-1.0)*(1.0)*x32*x33))+(((-1.0)*(1.0)*x31))))))+((x34*x38)));
eerot[2]=(((x34*((x31+((x15*x33))))))+((x30*x38)));
eetrans[0]=((((0.0812739207099744)*x29))+(((-1.0)*(0.114694326016242)*x14))+(((0.0812739207099744)*x19))+(((-1.0)*(0.31622584)*x6))+(((0.114694326016242)*x2))+(((0.31622584)*x9))+(((-1.0)*(0.00975)*x0))+((x39*x4)));
eerot[3]=((((-1.0)*(0.25)*x42))+(((-1.0)*(0.866025403784439)*x55))+(((0.25)*x41))+(((0.433012701892219)*x40))+(((0.433012701892219)*x46))+(((-1.0)*(0.866025403784439)*x50)));
eerot[4]=(((x34*x60))+((x30*((((x15*x57))+x56)))));
eerot[5]=(((x34*(((((-1.0)*(1.0)*x32*x57))+(((-1.0)*(1.0)*x56))))))+((x30*x60)));
eetrans[1]=((((-1.0)*(1.0)*x0*x39))+(((-1.0)*(0.0812739207099744)*x50))+(((0.31622584)*x41))+(((-1.0)*(0.31622584)*x42))+(((0.114694326016242)*x40))+(((-1.0)*(0.00975)*x4))+(((0.114694326016242)*x46))+(((-1.0)*(0.0812739207099744)*x55)));
eerot[6]=((((0.25)*x62))+((x10*((x35+(((-1.0)*(1.0)*x36))))))+(((-1.0)*(0.866025403784439)*x64))+(((-1.0)*(0.866025403784439)*x69))+(((0.25)*x61)));
eerot[7]=(((x30*((((x15*x71))+x70))))+((x34*x74)));
eerot[8]=(((x34*(((((-1.0)*(1.0)*x70))+(((-1.0)*(1.0)*x32*x71))))))+((x30*x74)));
eetrans[2]=((0.2755)+(((0.31622584)*x62))+(((-1.0)*(0.41)*x8))+(((0.31622584)*x61))+(((-1.0)*(0.0812739207099744)*x69))+((x10*(((((0.114694326016242)*x22))+(((-1.0)*(0.114694326016242)*x25))))))+(((-1.0)*(0.0812739207099744)*x64)));
}
...
new_r01=r02;
new_r02=((-1.0)*(((1.0)*r00)));
new_px=(px+(((-1.0)*(0.13660408)*r00)));
new_r10=r11;
new_r11=((-1.0)*(((1.0)*r12)));
new_r12=r10;
new_py=((((-1.0)*(1.0)*py))+(((0.13660408)*r10)));
new_r20=r21;
new_r21=((-1.0)*(((1.0)*r22)));
new_r22=r20;
new_pz=((0.2755)+(((0.13660408)*r20))+(((-1.0)*(1.0)*pz)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - jaco (e4df2a0934b18692ff2dc34a546dc7f9)>"; }
