...
///
/// ikfast version 0x10000049 generated on 2016-11-22 15:38:10.594659
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((((0.475748146969695)*x38))+(((-1.0)*(0.311931439146102)*x33))+(((-1.0)*(0.430100740359709)*x35))+(((0.475748146969695)*x37))+(((0.311931439146102)*x19))+(((-1.0)*(0.00975)*x2))+((x39*x8))+(((0.430100740359709)*x36)));
...
eetrans[1]=((((-1.0)*(0.475748146969695)*x60))+(((0.430100740359709)*x57))+(((-1.0)*(0.430100740359709)*x58))+(((-1.0)*(0.475748146969695)*x59))+(((-1.0)*(1.0)*x2*x39))+(((0.311931439146102)*x47))+(((0.311931439146102)*x55))+(((-1.0)*(0.00975)*x8)));
...
eetrans[2]=((0.2755)+(((-1.0)*(0.475748146969695)*x73))+(((0.430100740359709)*x65))+(((-1.0)*(0.475748146969695)*x74))+(((-1.0)*(0.41)*x10))+((x3*(((((-1.0)*(0.311931439146102)*x24))+(((0.311931439146102)*x21))))))+(((0.430100740359709)*x63)));
}
...
new_r01=r01;
new_r02=((-1.0)*(((1.0)*r02)));
new_px=(px+(((-1.0)*(0.592103681438838)*r02)));
new_r10=r10;
new_r11=((-1.0)*(((1.0)*r11)));
new_r12=r12;
new_py=((((0.592103681438838)*r12))+(((-1.0)*(1.0)*py)));
new_r20=r20;
new_r21=((-1.0)*(((1.0)*r21)));
new_r22=r22;
new_pz=((0.2755)+(((0.592103681438838)*r22))+(((-1.0)*(1.0)*pz)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - jaco (422b4cc063d00eeb844ac4bf9edc0c4d)>"; }
