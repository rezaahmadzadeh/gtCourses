...
///
/// ikfast version 0x10000049 generated on 2016-11-02 09:28:26.804153
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((((0.138726357766179)*x19))+(((0.129337984209849)*x38))+(((-1.0)*(0.138726357766179)*x33))+(((-1.0)*(0.33010074)*x35))+(((0.129337984209849)*x37))+(((-1.0)*(0.00975)*x2))+(((0.33010074)*x36))+((x39*x8)));
...
eetrans[1]=((((-1.0)*(0.129337984209849)*x59))+(((0.138726357766179)*x47))+(((-1.0)*(0.33010074)*x58))+(((-1.0)*(1.0)*x2*x39))+(((0.138726357766179)*x55))+(((-1.0)*(0.129337984209849)*x60))+(((-1.0)*(0.00975)*x8))+(((0.33010074)*x57)));
...
eetrans[2]=((0.2755)+(((0.33010074)*x65))+(((0.33010074)*x63))+(((-1.0)*(0.41)*x10))+(((-1.0)*(0.129337984209849)*x73))+((x3*(((((0.138726357766179)*x21))+(((-1.0)*(0.138726357766179)*x24))))))+(((-1.0)*(0.129337984209849)*x74)));
}
...
new_r01=r01;
new_r02=((-1.0)*(((1.0)*r02)));
new_px=(px+(((-1.0)*(0.19210368)*r02)));
new_r10=r10;
new_r11=((-1.0)*(((1.0)*r11)));
new_r12=r12;
new_py=((((-1.0)*(1.0)*py))+(((0.19210368)*r12)));
new_r20=r20;
new_r21=((-1.0)*(((1.0)*r21)));
new_r22=r22;
new_pz=((0.2755)+(((0.19210368)*r22))+(((-1.0)*(1.0)*pz)));
