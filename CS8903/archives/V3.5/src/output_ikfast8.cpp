...
///
/// ikfast version 0x10000049 generated on 2016-11-23 14:36:17.736537
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((((-1.0)*(0.176767978550089)*x33))+(((0.176767978550089)*x19))+(((-1.0)*(0.35206408)*x35))+(((0.35206408)*x36))+(((0.205421225777669)*x37))+(((-1.0)*(0.00975)*x2))+(((0.205421225777669)*x38))+((x39*x8)));
...
eetrans[1]=((((-1.0)*(0.35206408)*x58))+(((0.176767978550089)*x47))+(((-1.0)*(0.205421225777669)*x59))+(((-1.0)*(0.205421225777669)*x60))+(((0.176767978550089)*x55))+(((-1.0)*(1.0)*x2*x39))+(((0.35206408)*x57))+(((-1.0)*(0.00975)*x8)));
...
eetrans[2]=((0.2755)+(((-1.0)*(0.205421225777669)*x74))+(((0.35206408)*x63))+(((0.35206408)*x65))+(((-1.0)*(0.205421225777669)*x73))+(((-1.0)*(0.41)*x10))+((x3*(((((0.176767978550089)*x21))+(((-1.0)*(0.176767978550089)*x24)))))));
}
...
new_r01=r01;
new_r02=((-1.0)*(((1.0)*r02)));
new_px=(px+(((-1.0)*(0.27995704)*r02)));
new_r10=r10;
new_r11=((-1.0)*(((1.0)*r11)));
new_r12=r12;
new_py=((((-1.0)*(1.0)*py))+(((0.27995704)*r12)));
new_r20=r20;
new_r21=((-1.0)*(((1.0)*r21)));
new_r22=r22;
new_pz=((0.2755)+(((0.27995704)*r22))+(((-1.0)*(1.0)*pz)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - jaco (6e3f38c3937c61cc1119e68c0f545448)>"; }
