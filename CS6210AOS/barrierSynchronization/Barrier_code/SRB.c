...
#pragma omp critical
        ...
        /**************************************************************************************/
        /***** END TEST 3 : average contention for accessing the count i.e critical part *****/
        /**************************************************************************************/
        /***RESET PARAMETERS***/
        count = NUM_THREADS;
        sense = 0;
...
#pragma omp critical
        ...
        /**************************************************************************************/   
        /***** END TEST 5 : measure the contention of sense spinning with exponential backoff*****/
        /**************************************************************************************/
        /***RESET PARAMETERS***/
        count = NUM_THREADS;
        sense = 0;
...
#pragma omp critical
        ...
        /**************************************************************************************/   
        /***** END TEST 6 : measure the contention of sense spinning with linear backoff LB*****/
        /**************************************************************************************/
        /***RESET PARAMETERS***/
        count = NUM_THREADS;
        sense = 0;
...
#pragma omp critical
        ...
        /**************************************************************************************/   
        /***** END TEST 7 : measure the contention of sense spinning with linear backoff LB*****/
        /**************************************************************************************/
    }
    //fclose(fp);
    return 0;
